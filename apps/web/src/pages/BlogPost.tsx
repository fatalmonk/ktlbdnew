    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="relative">
          {/* Featured Image */}
          {postMeta.image && (
            <div className="w-full h-[400px] bg-neutral-200 relative">
              <img
                src={postMeta.image}
                alt={postMeta.title}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <header className={postMeta.image ? '-mt-32 relative z-10 mb-8' : 'mb-8'}>
                <div className={postMeta.image ? 'bg-white p-8 rounded-lg shadow-xl' : ''}>
                  ...
                  <div className="flex items-center gap-3 mt-6 pt-6 border-t">
                    <span className="text-neutral-600 text-sm font-semibold flex items-center gap-2">
                      <Suspense fallback={<div className="w-4 h-4" />}>
                    ...
                    <a
                      ...
                      className="p-2 rounded-full bg-neutral-100 hover:bg-blue-600 hover:text-white transition-colors"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-neutral-100 hover:bg-blue-400 hover:text-white transition-colors"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 rounded-full bg-neutral-100 hover:bg-blue-700 hover:text-white transition-colors"
              ...
              {postMeta.tags && postMeta.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mb-12 pb-12 border-b">
                  <span className="text-neutral-600 font-semibold">Tags:</span>
