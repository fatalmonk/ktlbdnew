        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-neutral-800 mb-8">
              Download our comprehensive media kit including company logos,
              brand guidelines, press photos, and other resources for
              journalists, partners, and media professionals.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800 mb-4">
                  High-quality press photos of facilities, products, and team
                  members for media use.
                </p>
                <button className="text-primary hover:underline">
                  Download Photos
                </button>
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800 mb-4">
                  Comprehensive company information, statistics, and key facts
                  for media reference.
                </p>
                <button className="text-primary hover:underline">
                  Download Fact Sheet
            ...
            <div className="mt-12 bg-primary/10 p-8 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-neutral-800">Email: press@ktlbd.com</p>
                  <p className="text-neutral-800">Phone: +880 1308 790475</p>
                </div>
                <div>
                  <h4 className="font-semibold text-black mb-2">
                    Media Relations
                  </h4>
                  <p className="text-neutral-800">Email: media@ktlbd.com</p>
                  <p className="text-neutral-800">Response time: 24-48 hours</p>
                </div>
              </div>
            </div>
          </div>
