          ...
          <div className="grid grid-cols-5 gap-8 mb-16">
            {directors.slice(0, 5).map((director) => (
              <div key={director.name} className="text-center">
                ...
                <h3 className="font-bold text-2xl lg:text-3xl text-black mb-2">{director.name}</h3>
                <p className="text-lg lg:text-xl text-neutral-700 leading-snug">{director.title}</p>
              </div>
            ))}
          </div>
              ...
              {committees.map((committee) => (
                ...
                >
                  ...
                  <div className="flex min-h-[46rem] flex-1 flex-col px-5 py-14 text-left sm:min-h-[50rem] sm:px-6 sm:py-16 lg:min-h-[52rem] lg:px-8 lg:py-16">
                    ...
                    >
                      <span className="leading-snug underline-offset-2 hover:underline">Download Charter PDF</span>
                      <Suspense fallback={<span className="inline-block h-8 w-8 shrink-0" aria-hidden />}>
                        <FileText className="h-8 w-8 shrink-0 text-slate-500 sm:h-9 sm:w-9 lg:h-10 lg:w-10" aria-hidden />
                      </Suspense>
                    </a>
                  </div>
                </div>
