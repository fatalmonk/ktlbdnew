          ...
          <div className="grid grid-cols-5 gap-8 mb-16">
            {directors.slice(0, 5).map((director) => (
              <div key={director.name} className="text-center">
                ...
                <p className="text-sm text-neutral-700 leading-tight">{director.title}</p>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {committees.map((committee) => (
              <div key={committee.name} className="bg-white border border-neutral-200 overflow-hidden shadow-sm">
                ...
                <div className="p-4 bg-white">
                  <div className="space-y-2 mb-6">
                    {committee.members.map((member) => (
                      <div key={member.name}>
                        ...
                        {member.role && (
                          <div className="text-xs text-neutral-600 ml-2">({member.role})</div>
                        )}
                      </div>
                    ))}
                  </div>
                  <div className="pt-4">
                    <a
                      href="#"
                      className="inline-flex items-center text-sm font-medium text-neutral-600 hover:text-neutral-800 transition-colors"
                      title="PDF link placeholder - replace with actual PDF URL"
                    >
                      Download Charter PDF
                      <Suspense fallback={<div className="w-4 h-4 ml-2" />}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {documents.map((document) => (
              <a
                key={document}
                href="#"
                className="block p-4 bg-white border border-neutral-200 hover:bg-neutral-50 transition-colors rounded-lg"
                title="PDF link placeholder - replace with actual PDF URL"
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-xs font-medium text-neutral-600">PDF</span>
                  </div>
                </div>
              </a>
            ))}
