  ...
  return (
    <>
      <SEO
        ...
        description="Kattali Textile Limited (KTL)'s sustainability initiatives include Nirapon, Better Work, and Walmart Green certifications, ensuring ethical and environmentally responsible garment production."
        canonical="/company/sustainability"
        keywords={['sustainable textile manufacturer', 'ethical manufacturing', 'green factory', 'sustainable fashion', 'eco-friendly textile', 'KTL sustainability', 'KTL ethical manufacturing', 'KTL green factory', 'KTL sustainable fashion', 'KTL eco-friendly textile']}
      />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                ...
                maintaining quality. Our <Link to="/products" className="text-primary-600 hover:text-primary-700 font-medium underline">sustainable textile products</Link> are manufactured in our <Link to="/facilities/rmg" className="text-primary-600 hover:text-primary-700 font-medium underline">eco-friendly production facilities</Link>.
              </p>
            </div>
              ...
              {initiatives.map((initiative, index) => (
                ...
                >
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <h3 className="font-heading text-xl font-bold mb-3 text-neutral-900">
                        {initiative.title}
                      </h3>
              ...
              {environmentalGoals.map((goal, index) => (
                <div key={index} className="bg-white p-6 rounded-xl shadow-lg">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-semibold text-neutral-900">{goal.goal}</h3>
                  ...
                  <div className="text-right text-sm text-neutral-600">{goal.progress}% Complete</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {certifications.map((cert, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold mb-4 text-neutral-900">{cert.name}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {socialImpact.map((impact, index) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-neutral-900 mb-2">{impact.label}</h3>
                  <p className="text-neutral-600 text-sm">{impact.description}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6 text-neutral-700 text-lg leading-relaxed">
                  <p>
                    Since our establishment in 2002, sustainability has been at the core of our
                  ...
                  <p>
                    ...
                    initiatives that create lasting positive impact. This commitment extends to all our 
                    <Link to="/products" className="text-primary-600 hover:text-primary-700 font-medium underline"> product lines</Link>, including our 
                    <Link to="/products/denims" className="text-primary-600 hover:text-primary-700 font-medium underline"> sustainable denim manufacturing</Link>.
                  </p>
                  <p>
              ...
              <div className="relative">
                <Image
                  ...
                  alt="Sustainable textile manufacturing process with eco-friendly practices and certified environmental standards at Kattali Textile Limited in Chittagong, Bangladesh"
