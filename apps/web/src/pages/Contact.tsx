  ...
  return (
    <>
      <SEO
        ...
        keywords={[
          'KTL contact',
          'textile manufacturer contact',
          'Bangladesh garment inquiry',
          'investor relations',
          'chittagong exporter list',
        ]}
      />
      <StructuredData
        data={[createBreadcrumbSchema(breadcrumbs), createContactSchema(), createFAQSchema(faqs)]}
      />
      <SubpageHeader
                    ...
                    <div className="space-y-1">
                      {info.details.map((detail, detailIndex) =>
                        info.links && info.links[detailIndex] ? (
                          ...
                          <p
                            key={detailIndex}
                            className="text-caption leading-[1.6] text-[#CCCCCC]"
                          >
                            {detail}
                          </p>
                        )
        ...
        <section className="relative bg-neutral-900 py-20 px-4">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-12">
              <h2 className="font-heading font-bold text-h4 md:text-h3 text-white mb-4">Find Us</h2>
              <p className="text-neutral-300 text-lg">
                ...
                in Chittagong or connect with us on Google Business Profile
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <GoogleBusinessWidget showMap={true} showReviews={true} showDirections={true} />
              </div>
            </div>
          </div>
        </section>
