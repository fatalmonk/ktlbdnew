  ...
  return (
    <>
      <SEO
        ...
        description="Internal testing page for animation components"
        canonical="/test/animation"
        noIndex={true}
      />
                ...
                <div className="bg-white rounded-lg p-6 shadow-md">
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      <span className="w-16 text-neutral-500">0.0s</span>
                      <span>Scrubber moves right, mask scales down</span>
                    </div>
                    <div className="flex items-center">
                      <span className="w-16 text-neutral-500">0.5s</span>
                    ...
                    <div className="flex items-center">
                      <span className="w-16 text-neutral-500">Speed</span>
