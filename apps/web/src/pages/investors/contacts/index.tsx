            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-neutral-800">investors@ktlbd.com</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-black">Phone</h4>
                    <p className="text-neutral-800">+880 1308 790475</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-black">Response Time</h4>
                    <p className="text-neutral-800">24-48 hours</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-black">Email</h4>
                    <p className="text-neutral-800">shareholders@ktlbd.com</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-black">Phone</h4>
                    <p className="text-neutral-800">+880 1308 790476</p>
                  </div>
                  <div>
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-black">Email</h4>
                    <p className="text-neutral-800">finance@ktlbd.com</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-black">Phone</h4>
                    <p className="text-neutral-800">+880 1308 790477</p>
                  </div>
                  <div>
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold text-black">Email</h4>
                    <p className="text-neutral-800">press@ktlbd.com</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-black">Phone</h4>
                    <p className="text-neutral-800">+880 1308 790478</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-black">Response Time</h4>
                    <p className="text-neutral-800">24 hours</p>
                  </div>
                </div>
              </div>
            </div>
