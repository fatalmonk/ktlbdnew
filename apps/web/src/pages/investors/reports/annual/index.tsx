            ...
            <div className="space-y-6">
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800 mb-4">
                  Complete annual report for 2023 including financial
                  performance, sustainability initiatives, and strategic
                  achievements.
                </p>
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800 mb-4">
                  Annual report highlighting growth in international markets and
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800 mb-4">
                  Annual report focusing on digital transformation and
