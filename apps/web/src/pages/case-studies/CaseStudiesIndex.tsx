...
const CaseStudiesIndex = () => {
  ...
  const filteredCaseStudies = useMemo(() => {
    return caseStudies.filter((cs) => {
      const matchesIndustry =
        !filters.industry || cs.industry.includes(filters.industry);
      const matchesProduct =
        !filters.product || cs.products.includes(filters.product);
      const matchesSearch =
        !filters.searchQuery ||
  ...
  const hasActiveFilters =
    filters.industry || filters.product || filters.searchQuery;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
                Real results from real partnerships. See how we've helped global
                brands achieve their manufacturing goals.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            {hasActiveFilters && (
              <div className="mt-4 flex items-center justify-between">
                <div className="text-sm text-neutral-600">
                  Showing {sortedCaseStudies.length} of {caseStudies.length}{" "}
                  case studies
                </div>
                <button
                  onClick={handleReset}
        ...
        <section className="bg-blue-900 text-white py-16 mt-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Let's discuss how we can help you achieve your manufacturing
              goals.
            </p>
