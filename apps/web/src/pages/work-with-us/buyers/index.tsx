        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-neutral-800 mb-8">
              Partner with KTL for comprehensive textile solutions. We offer
              quality products, reliable supply chain, and dedicated support for
              your business needs.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800">
                  Rigorous quality control processes and certifications ensuring
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800">
                  Efficient global distribution network with reliable shipping
