          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800">
                  Expert handling of customs procedures and international trade
                  compliance for seamless global shipping.
                </p>
              </div>
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800">
                  Real-time shipment tracking and monitoring systems for
                  complete visibility and customer satisfaction.
                </p>
              </div>
            </div>
          </div>
