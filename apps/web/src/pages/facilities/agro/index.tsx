        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-neutral-800 mb-8">
              Our agricultural facility focuses on sustainable cotton production
              and organic farming practices to support eco-friendly textile
              manufacturing.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800">
                  Efficient irrigation systems and water management practices to
              ...
              <div className="bg-neutral-50 p-6 rounded-lg">
                ...
                <p className="text-neutral-800">
                  Supporting local farming communities through fair trade
                  practices and sustainable agricultural development programs.
                </p>
              </div>
            </div>
          </div>
