          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <p className="text-lg text-neutral-800 mb-6">
                As a leading <strong>denim manufacturer in Bangladesh</strong>,
                KTL specializes in producing high-quality denim products for
                global fashion brands. Our state-of-the-art denim production
                facilities in Chittagong combine traditional craftsmanship with
                modern technology to deliver premium jeans, denim jackets, and
                accessories.
              </p>
              <p className="text-lg text-neutral-800 mb-6">
                Our <strong>denim manufacturing</strong> capabilities include
                advanced washing techniques, custom finishing processes, and
                sustainable production practices. We work with premium denim
                fabrics and offer a wide range of styles from classic
                straight-fit jeans to contemporary denim jackets and
                accessories. Explore our full range of{" "}
                <Link
                  to="/products"
