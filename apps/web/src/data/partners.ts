...
export const partners: PartnerLogo[] = [
  {
    ...
    description: 'Global fashion brand known for premium denim and contemporary clothing',
  ...
  },
  {
    ...
    name: 'GAP',
    logo: gapLogo,
    description: 'American clothing and accessories retailer with global presence',
  ...
  },
  {
    ...
    name: 'H&M',
    logo: hmLogo,
    description: 'Swedish multinational clothing retailer focused on fast fashion',
  ...
  },
  {
    ...
    name: 'Old Navy',
    logo: oldNavyLogo,
    description: 'American clothing and accessories retailer, subsidiary of Gap Inc.',
