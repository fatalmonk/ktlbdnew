...
import { createOrganizationSchema, createWebsiteSchema } from './modules/seo/templates';
...
// Case Studies pages
const CaseStudiesIndex = React.lazy(() => import('./pages/case-studies/CaseStudiesIndex'));
const CaseStudyDetail = React.lazy(() => import('./pages/case-studies/CaseStudyDetail'));
...
const ResponsiveHooksTest = React.lazy(() => import('./components/test/ResponsiveHooksTest'));
            ...
            <main>
              <Suspense fallback={<Loading />}>
                <Routes>
                  ...
                  <Route path="/certifications" element={<CertificationsHub />} />
