...
test.describe("Site Navigation", () => {
  ...
  test.describe("Header Navigation", () => {
    ...
    test("should navigate to Company overview from header", async ({
      page,
    }) => {
      await page
    ...
    test("should navigate to Investors page", async ({ page }) => {
      ...
      const investorLink = page
        .getByRole("link", { name: /Investor/i })
        .first();
  ...
  test.describe("Call-to-Action Buttons", () => {
    test("should navigate to products from hero CTA", async ({ page }) => {
      const exploreCTA = page.getByRole("link", {
    ...
    test("should navigate to all products from products section", async ({
      page,
    }) => {
      const viewAllProducts = page.getByRole("link", {
  ...
  test.describe("Breadcrumb Navigation", () => {
    test("should navigate back to home from products page", async ({
      page,
    }) => {
      ...
      if (await homeLink.isVisible()) {
        ...
        // Try clicking logo
        const logo = page
          .locator('img[alt*="KTL"], img[alt*="Kattali"]')
          .first();
  ...
  test.describe("Investor Relations", () => {
    ...
    test("should display stock price on investor overview", async ({
      page,
    }) => {
      ...
      await expect(
        metricBand.getByRole("heading", { name: /Investor Snapshot/i }),
      ).toBeVisible();
