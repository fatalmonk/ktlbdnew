...
const routes = [
  ...
  {
    path: "/case-studies/european-premium-denim-brand",
    priority: 0.8,
    changefreq: "monthly",
  },
  {
    path: "/case-studies/us-sportswear-sustainability",
    priority: 0.8,
    changefreq: "monthly",
  },
  {
  ...
  {
    path: "/case-studies/fast-fashion-speed-to-market",
    priority: 0.8,
    changefreq: "monthly",
  },
  {
...
async function main() {
  ...
  try {
    ...
    console.log(
      `  - ${routes.filter((r) => r.path.startsWith("/products")).length} Product pages`,
    );
    console.log(
      `  - ${routes.filter((r) => r.path.startsWith("/company")).length} Company pages`,
    );
    console.log(
