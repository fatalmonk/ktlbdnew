...
const TechFacility = () => {
  return (
    <>
      <SEO
        title="Tech Facility"
        description="KTL's technology facility featuring advanced machinery, automation systems, and digital solutions for modern textile manufacturing."
        keywords={['tech facility', 'automation', 'digital manufacturing', 'KTL technology', 'advanced machinery']}
      />
